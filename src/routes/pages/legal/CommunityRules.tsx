import rulesContent from "../../../text-content/legal-community-rules";

const CommunityRules = () => {
  return (
    <div className="container max-w-150 lg:max-w-235">
      <h2 className="about-heading">{rulesContent.heading}</h2>

      <p className="text-sm opacity-80 mb-6">
        Version {rulesContent.version} • Last updated: {rulesContent.lastUpdated}
      </p>

      <p className="about-paragraph">{rulesContent.intro}</p>

      <div className="mt-6 flex flex-col gap-6">
        {rulesContent.sections.map((s) => (
