...
const Home = () => {
  return (
    ...
    >
      <img className="mx-auto mt-[calc(1rem+2vw)] sm:mt-10 w-[calc(220px+12vw)]" src={homeImg} alt="books" />

      <div data-label="home-content-container" className="w-[90%] mx-auto md:w-full">
